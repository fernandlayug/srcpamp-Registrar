...
Public Class DeleteAdmission
    ...
    Private Sub OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK.Click
        ...
        If damyname.HasRows Then
            ...
            If Me.UsernameTextBox.Text = verifyusername.Text And Me.PasswordTextBox.Text = verifypassword.Text And Me.account.Text = "Administrator" Or Me.account.Text = "Registrar" Then
