...
Public Class rptSubjectEnrollees
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSubjectEnrollees.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptSubjectEnrollees.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSubjectEnrollees
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSubjectEnrollees = New rptSubjectEnrollees()
        rpt.Site = Me.Site
        Return rpt
    End Function
