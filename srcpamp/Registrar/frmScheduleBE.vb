...
Public Class frmScheduleBE
    ...
    Private Sub fetch_LeveLID()
        ...
        End Try
    End Sub
    Private Sub fetch_department()
        Dim categoryA As String = "Junior HS"
    ...
    Private Sub SeniorHS_CheckedChanged(sender As Object, e As EventArgs) Handles Elementary.CheckedChanged
        If Elementary.Checked = True Then
            empcategory = "ELEM Faculty"
            category = "Elementary"
        End If
    End Sub

    Private Sub College_CheckedChanged(sender As Object, e As EventArgs) Handles JuniorHS.CheckedChanged
        If JuniorHS.Checked = True Then
