...
Public Class studentfile
    ...
    Private Sub registration_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        If e.KeyCode = Keys.F3 Then
            searchid.frmactive = "studentfile"
            searchid.ShowDialog()
    ...
    Private Sub print_registration2()
        ...
        ' Report.ShowDialog()
    End Sub
    Private Sub print_registration3()
        Dim sqlQRY1 As String = "select * FROM admissionVIEW where studentid = '" & studid.Text & "'AND sy = '" & txtSY.Text & "' AND levelid = '" & txtlevelid.Text & "' AND term = '" & sem & "' ;"
        Dim sqlQRY2 As String = "select * FROM subjectenrolledview where studentid = '" & studid.Text & "'AND sy = '" & txtSY.Text & "' AND levelid = '" & txtlevelid.Text & "' AND term = '" & sem & "' ORDER BY subjectcode ASC;"
        Dim sqlQRY3 As String = "select * FROM studentdata where studentid = '" & studid.Text & "'"
        ...
        Dim mReport As rptSubjectEnrolledLibrary = New rptSubjectEnrolledLibrary
        ...
        Report.ShowDialog()
    End Sub
    Private Sub print_registrationSHS()
        Dim sqlQRY1 As String = "select * FROM admissionVIEW where studentid = '" & studid.Text & "'AND sy = '" & txtSY.Text & "' AND levelid = '" & txtlevelid.Text & "' AND term = '" & sem & "' ;"
        Dim sqlQRY2 As String = "select * FROM subjectenrolledview where studentid = '" & studid.Text & "'AND sy = '" & txtSY.Text & "' AND levelid = '" & txtlevelid.Text & "' AND term = '" & sem & "' ORDER BY subjectcode ASC;"
        Dim sqlQRY3 As String = "select * FROM studentdata where studentid = '" & studid.Text & "'"
        ...
        Dim mReport As rptSubjectEnrolledSHS = New rptSubjectEnrolledSHS
        ...
        'Report.ShowDialog()
    End Sub
    Private Sub print_registrationSHSAcct()
        Dim sqlQRY1 As String = "select * FROM admissionVIEW where studentid = '" & studid.Text & "'AND sy = '" & txtSY.Text & "' AND levelid = '" & txtlevelid.Text & "' AND term = '" & sem & "' ;"
        Dim sqlQRY2 As String = "select * FROM subjectenrolledview where studentid = '" & studid.Text & "'AND sy = '" & txtSY.Text & "' AND levelid = '" & txtlevelid.Text & "' AND term = '" & sem & "' ORDER BY subjectcode ASC;"
        Dim sqlQRY3 As String = "select * FROM studentdata where studentid = '" & studid.Text & "'"
        ...
        Dim mReport As rptSubjectEnrolledSHSAcct = New rptSubjectEnrolledSHSAcct
    ...
    Private Sub btnPrint_Click(sender As System.Object, e As System.EventArgs) Handles btnPrint.Click
        If txtCategory.Text = "COLLEGE" Then
            If sqlconn.State = ConnectionState.Open Then
                sqlconn.Close()
                sqlconn.Open()
            ...
            Else
                ...
                sqlconn.Close()
            End If
        ElseIf txtCategory.Text = "SENIOR HS" Then
            If sqlconn.State = ConnectionState.Open Then
                sqlconn.Close()
                sqlconn.Open()
            ...
            If sqlconn.State = ConnectionState.Open Then
                sqlconn.Close()
                sqlconn.Open()
                Call print_registrationSHSAcct()
                sqlconn.Close()
            Else
                sqlconn.Open()
                Call print_registrationSHSAcct()
