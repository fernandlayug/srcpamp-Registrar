...
Public Class rptStudentData
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptStudentData.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStudentData
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStudentData = New rptStudentData()
        rpt.Site = Me.Site
        Return rpt
    End Function
