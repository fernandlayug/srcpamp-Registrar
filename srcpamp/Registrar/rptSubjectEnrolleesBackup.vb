...
Public Class rptSubjectEnrolleesBackup
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSubjectEnrolleesBackup.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptSubjectEnrolleesBackup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSubjectEnrolleesBackup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSubjectEnrolleesBackup = New rptSubjectEnrolleesBackup()
        rpt.Site = Me.Site
        Return rpt
    End Function
