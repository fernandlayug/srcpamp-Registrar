...
Public Class rptFacultySubjects
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptFacultySubjects.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacultySubjects
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacultySubjects = New rptFacultySubjects()
        rpt.Site = Me.Site
        Return rpt
    End Function
