...
Public Class rptCourseEnrollees
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptCourseEnrollees.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCourseEnrollees
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCourseEnrollees = New rptCourseEnrollees()
        rpt.Site = Me.Site
        Return rpt
    End Function
