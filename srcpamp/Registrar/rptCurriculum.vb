...
Public Class rptCurriculum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptCurriculum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCurriculum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCurriculum = New rptCurriculum()
        rpt.Site = Me.Site
        Return rpt
    End Function
