...
Public Class rptFacultySubjectsTemp
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFacultySubjectsTemp.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptFacultySubjectsTemp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacultySubjectsTemp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacultySubjectsTemp = New rptFacultySubjectsTemp()
        rpt.Site = Me.Site
        Return rpt
    End Function
