...
Public Class registrationtemp
    ...
    Private Sub fetch_sy()
        ...
        End If
    End Sub
    Private Sub registrationtemp_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        ElseIf e.KeyCode = Keys.F3 Then
            searchid.frmactive = "registrationtemp"
            searchid.ShowDialog()
    ...
    Private Sub registrationtemp_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub generate_id()
        ...
        Try
            ...
            studentid.Text = cmbyear.Text + "-" + studentsequenceID
    ...
    Private Sub finalize_records()
        ...
        ElseIf submit.Text = "Register" Then
            ...
            strsql = " INSERT into studentdata_temp ([id],[studentid],[lrn],[ESCNO],[firstname],[mname],[surname],[ExtName], " &
                "[sex],[birthday],[birthplace],[address],[address1],[address2],[address3], " &
                "[telephone],[mobile],[email],[religion],[citizenship], " &
                "[father], [f_firstname], [f_mname],[f_ext],[mother],[m_firstname], [m_mname], [m_ext], " &
                "[guardian],[guardcontact], [cmbrelation], [pic],[remarks], [dateregistered], [level], [track]) values ('" & table_id & "','" & studentid.Text & "', " &
                "'" & txtLRN.Text & "','" & txtESC.Text & "','" & firstname.Text & "','" & mname.Text & "','" & surname.Text & "', " &
                "'" & ExtName.Text & "'," &
                "'" & sex.Text & "','" & birthday.Text & "','" & birthplace.Text & "', " &
                "'" & address.Text & "','" & address1.Text & "','" & address2.Text & "','" & address3.Text & "'," &
                "'" & telephone.Text & "','" & mobile.Text & "','" & txtEmail.Text & "','" & religion.Text & "','" & citizenship.Text & "'," &
                "'" & father.Text & "','" & f_firstname.Text & "','" & f_mname.Text & "','" & f_ext.Text & "'," &
                "'" & mother.Text & "','" & m_firstname.Text & "','" & m_mname.Text & "','" & m_ext.Text & "'," &
                "'" & guardian.Text & "','" & guardcontact.Text & "', " &
                "'" & cmbrelation.Text & "', @picstudent,'" & r & "','" & datetoday.Text & "','" & cmblevel.Text & "','" & cmbcourse.Text & "')"
    ...
    Private Sub RadioButton1_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton1.CheckedChanged
        ...
        cmblevel.Items.Add("Junior Kinder")
        cmblevel.Items.Add("Senior Kinder")
    ...
    Private Sub RadioButton3_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton3.CheckedChanged
        ...
        cmblevel.Items.Clear()
        cmblevel.Items.Add("Grade-11")
        cmblevel.Items.Add("Grade-12")
        cmblevel.Text = "Select from.."
    ...
    Private Sub RadioButton4_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton4.CheckedChanged
        ...
        cmblevel.Items.Clear()
        cmblevel.Items.Add("1st Year")
        cmblevel.Items.Add("2nd Year")
        cmblevel.Items.Add("3rd Year")
        cmblevel.Items.Add("4th Year")

        cmblevel.Text = "Select from.."

        cmbcourse.Items.Clear()
        cmbcourse.Items.Add("BSED")
        cmbcourse.Items.Add("BEED")
        cmbcourse.Items.Add("BSAIS")
        cmbcourse.Items.Add("BS Entrep")
        cmbcourse.Items.Add("BSIS")
    End Sub
