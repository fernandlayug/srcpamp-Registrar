...
Public Class rptAdmissionAlpha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptAdmissionAlpha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAdmissionAlpha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAdmissionAlpha = New rptAdmissionAlpha()
        rpt.Site = Me.Site
        Return rpt
    End Function
