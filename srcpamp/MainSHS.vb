...
Public Class MainSHS
    ...
    Private Sub MainSHS_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If e.CloseReason = CloseReason.UserClosing Then e.Cancel = True
    End Sub

    Private Sub MainSHS_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
