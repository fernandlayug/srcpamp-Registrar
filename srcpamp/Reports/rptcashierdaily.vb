...
Public Class rptcashierdaily
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptcashierdaily.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptcashierdaily
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptcashierdaily = New rptcashierdaily()
        rpt.Site = Me.Site
        Return rpt
    End Function
