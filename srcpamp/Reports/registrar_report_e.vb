...
Public Class registrar_report_e
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.registrar_report_e.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedregistrar_report_e
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As registrar_report_e = New registrar_report_e()
        rpt.Site = Me.Site
        Return rpt
    End Function
