...
Public Class rptcashierOrNum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptcashierOrNum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptcashierOrNum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptcashierOrNum = New rptcashierOrNum()
        rpt.Site = Me.Site
        Return rpt
    End Function
