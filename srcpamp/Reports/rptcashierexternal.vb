...
Public Class rptcashierexternal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptcashierexternal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptcashierexternal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptcashierexternal = New rptcashierexternal()
        rpt.Site = Me.Site
        Return rpt
    End Function
