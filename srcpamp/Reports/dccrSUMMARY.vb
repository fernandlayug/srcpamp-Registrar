...
Public Class dccrSUMMARY
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.dccrSUMMARY.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_mycashiername() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CacheddccrSUMMARY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As dccrSUMMARY = New dccrSUMMARY()
        rpt.Site = Me.Site
        Return rpt
    End Function
