...
Public Class registrar_report_c
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.registrar_report_c.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedregistrar_report_c
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As registrar_report_c = New registrar_report_c()
        rpt.Site = Me.Site
        Return rpt
    End Function
