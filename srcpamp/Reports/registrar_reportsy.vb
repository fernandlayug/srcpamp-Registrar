...
Public Class registrar_reportsy
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.registrar_reportsy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedregistrar_reportsy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As registrar_reportsy = New registrar_reportsy()
        rpt.Site = Me.Site
        Return rpt
    End Function
