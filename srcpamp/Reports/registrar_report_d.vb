...
Public Class registrar_report_d
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.registrar_report_d.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedregistrar_report_d
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As registrar_report_d = New registrar_report_d()
        rpt.Site = Me.Site
        Return rpt
    End Function
