...
Public Class rptpromisory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptpromisory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptpromisory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptpromisory = New rptpromisory()
        rpt.Site = Me.Site
        Return rpt
    End Function
