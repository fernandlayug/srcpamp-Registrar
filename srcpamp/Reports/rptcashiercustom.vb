...
Public Class rptcashiercustom
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "srcregistrar.rptcashiercustom.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptcashiercustom
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptcashiercustom = New rptcashiercustom()
        rpt.Site = Me.Site
        Return rpt
    End Function
