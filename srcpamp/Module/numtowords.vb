Module numtowords
    ...
    Function AmtInWord(ByVal Num As Decimal) As String
        ...
        If InStr(1, strNum, ".") <> 0 Then
            ...
            'StrWord = IIf(CDbl(strNum) = 1, " Pesos ", " Pesos ") + NumToWord(CDbl(strNum)) + IIf(CDbl(strNumDec) > 0, " and Cents" + cWord3(CDbl(strNumDec)), "")
            StrWord = IIf(CDbl(strNum) = 1, "", "") + NumToWord(CDbl(strNum)) + " Pesos" + IIf(CDbl(strNumDec) > 0, " and " + cWord3(CDbl(strNumDec)) + " Cents", "")

        Else
            StrWord = IIf(CDbl(strNum) = 1, "", "") + NumToWord(CDbl(strNum)) + "Pesos"
    ...
    Function retWord(ByVal Num As Decimal) As String
        ...
        retWord = ""
        Dim ArrWordList(,) As Object = {{0, "Zero"}, {1, "One"}, {2, "Two"}, {3, "Three"}, {4, "Four"}, _
