...
Public Class MainCollege
    ...
    Private Sub MainCollege_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If e.CloseReason = CloseReason.UserClosing Then e.Cancel = True
    End Sub

    Private Sub MainCollege_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Public Sub registrationlink_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs)
        registration.ShowDialog()
    End Sub
    ...
    Private Sub schedulinglink_LinkClicked_1(sender As System.Object, e As System.Windows.Forms.LinkLabelLinkClickedEventArgs)
    ...
    Private Sub linkstudentreport_LinkClicked(sender As System.Object, e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles linkstudentreport.LinkClicked
        frmSubjectStudents.chkSeniorCourse.Enabled = False
        frmSubjectStudents.chkSeniorHSFaculty.Enabled = False
        frmSubjectStudents.cay = SY.Text
        frmSubjectStudents.ShowDialog()
    End Sub

    Private Sub linkschedule_LinkClicked(sender As System.Object, e As System.Windows.Forms.LinkLabelLinkClickedEventArgs)
