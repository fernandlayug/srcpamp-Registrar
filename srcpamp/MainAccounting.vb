...
Public Class MainAccounting
    ...
    Private Sub MainAccounting_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If e.CloseReason = CloseReason.UserClosing Then e.Cancel = True
    End Sub

    Private Sub MainAccounting_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
