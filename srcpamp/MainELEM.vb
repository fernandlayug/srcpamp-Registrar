...
Public Class MainELEM
    ...
    Private Sub MainELEM_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If e.CloseReason = CloseReason.UserClosing Then e.Cancel = True
    End Sub

    Private Sub MainELEM_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub linkstudentreport_LinkClicked(sender As System.Object, e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles linkstudentreport.LinkClicked
        frmSubjectStudentsBE.chkJuniorHS.Enabled = False
        frmSubjectStudentsBE.chkJuniorHSFaculty.Enabled = False
        frmSubjectStudentsBE.cay = SY.Text
